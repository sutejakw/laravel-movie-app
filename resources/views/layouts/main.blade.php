...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="/img/web-icon.png">
  <link rel="icon" type="image/png" sizes="32x32" href="/img/web-icon.png">
  <link rel="icon" type="image/png" sizes="16x16" href="/img/web-icon.png">
