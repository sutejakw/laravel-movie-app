...
@section('content')
  <div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
      <div class="flex-none">
        <img src="{{ $actor['profile_path'] }}" alt="Actor" class="w-80 md:w-96">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          @foreach ($knownForMovies as $movie)
            <div class="mt-4">
              ...
              <a href="#" class="text-sm leading-normal block text-gray-400 hover:text-white mt-1">{{ $movie['original_title'] }}</a>
            </div>
          @endforeach
        </div>
